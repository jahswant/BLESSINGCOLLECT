...
public class b4xpagesmanager extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.b4xpagesmanager");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.b4xpagesmanager.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public cm.jahswant.foodhunter.b4xorderedmap _vvvvvvvvvvvvvvvvvvv1 = null;
public cm.jahswant.foodhunter.b4xorderedmap _vvvvvvvvvvvvvvvvvvv2 = null;
public anywheresoftware.b4j.object.JavaObject _vvvvvvvvvvvvvvvvvvv3 = null;
public cm.jahswant.foodhunter.b4xset _vvvvvvvvvvvvvvvvvvv4 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper.XUI _vvvvv0 = null;
public anywheresoftware.b4a.objects.ActivityWrapper _vvvvvvvvvvvvvvvvvvv5 = null;
public boolean _vvvvvvvvvvvvvvvvvvv6 = false;
public anywheresoftware.b4j.object.JavaObject _vvvvvvvvvvvvvvvvvvv7 = null;
public boolean _vvvvvvvvvvvvvvvvvvv0 = false;
public int _vvvvvvvvvvvvvvvvvvvv1 = 0;
public cm.jahswant.foodhunter.b4xmainpage _vvv4 = null;
public String _vvvvvvvvvvvvvvvvvvvv2 = "";
public boolean _vvvvvvvvvvvvvvvvvvvv3 = false;
...
public cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent Parent;
public void Initialize() {
IsInitialized = true;
B4XPage = new Object();
Id = "";
...
IsFirst = false;
Parent = new cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent();
}
@Override
		public String toString() {
			return BA.TypeToString(this, false);
...
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
_vvvvvvvvvvvvvvvvvv3(_vvvvvvvvvvvvvvvvv7(),"B4XPage_Disappear",(Object[])(__c.Null));
 //BA.debugLineNum = 634;BA.debugLine="BackgroundStateChanged(False)";
_vvvvvvvvvvvvvvvv3(__c.False);
...
_shouldraise = _vvvvvvvvvvvvvvvvvvv0==__c.False;
 //BA.debugLineNum = 609;BA.debugLine="BackgroundStateChanged(True)";
_vvvvvvvvvvvvvvvv3(__c.True);
...
_vvvvvvvvvvvvvvvvvv2(_vvvvvvvvvvvvvvvvv7(),"B4XPage_Appear",(Object[])(__c.Null));
 };
 //BA.debugLineNum = 613;BA.debugLine="End Sub";
return "";
}
public cm.jahswant.foodhunter.b4xpagesmanager._b4amenuitem  _vv2(Object _b4xpage,Object _title) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4amenuitem _mi = null;
...
_mi = new cm.jahswant.foodhunter.b4xpagesmanager._b4amenuitem();
...
_vvvvvvvvvvvvvvvvv4(_b4xpage).Parent /*cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_mi));
 //BA.debugLineNum = 484;BA.debugLine="Return mi";
if (true) return _mi;
 //BA.debugLineNum = 485;BA.debugLine="End Sub";
return null;
}
public String  _vv3(String _id,Object _b4xpage) throws Exception{
String _idtolower = "";
...
if (_vvvvvvvvvvvvvvvvvvv1._vvvvvvvvvvvv6 /*boolean*/ ((Object)(_idtolower))) { 
...
_vvvvvvvvvvvvvvvvvvv1._vvvvvvvvvvvvv3 /*String*/ ((Object)(_idtolower),(Object)(_vvvvvvvvvvvvvvvv7(_b4xpage,_idtolower,__c.False,(Object)(_id))));
 //BA.debugLineNum = 148;BA.debugLine="If IdToB4XPage.Size = 1 Then ShowPage(IdToLower)";
if (_vvvvvvvvvvvvvvvvvvv1._getvvvvvvvvvv2 /*int*/ ()==1) { 
_vvv6(_idtolower);};
 //BA.debugLineNum = 149;BA.debugLine="End Sub";
return "";
}
public String  _vv4(String _id,Object _b4xpage) throws Exception{
...
_vvvvvvvvvvvvvvvvv2(_vvvvvvvvvvvvvvvvv5(_id));
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvv3(boolean _newstate) throws Exception{
String _ev = "";
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
if (_vvvvvvvvvvvvvvvvvvv0==_newstate) { 
if (true) return "";};
 //BA.debugLineNum = 617;BA.debugLine="IsForeground = NewState";
_vvvvvvvvvvvvvvvvvvv0 = _newstate;
...
if (_vvvvvvvvvvvvvvvvvvv0) { 
_ev = "B4XPage_Foreground";}
else {
_ev = "B4XPage_Background";};
 //BA.debugLineNum = 620;BA.debugLine="For Each pi As B4XPageInfo In IdToB4XPage.Values";
{
final anywheresoftware.b4a.BA.IterableList group5 = _vvvvvvvvvvvvvvvvvvv1._getvvvvvvvvvvvvvvv5 /*anywheresoftware.b4a.objects.collections.List*/ ();
final int groupLen5 = group5.getSize()
;int index5 = 0;
;
for (; index5 < groupLen5;index5++){
_pi = (cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo)(group5.Get(index5));
 //BA.debugLineNum = 621;BA.debugLine="If xui.SubExists(pi.B4XPage, ev, 0) Then";
if (_vvvvv0.SubExists(ba,_pi.B4XPage /*Object*/ ,_ev,(int) (0))) { 
 //BA.debugLineNum = 622;BA.debugLine="LogEvent(pi, ev)";
_vvvvvvvvvvvvvvvvvv1(_pi,_ev);
...
_vvvvvvvvvvvvvvvvvvv7 = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_jo.RunMethod("getActionBar",(Object[])(__c.Null))));
 //BA.debugLineNum = 102;BA.debugLine="If ActionBar.IsInitialized = False Then";
if (_vvvvvvvvvvvvvvvvvvv7.IsInitialized()==__c.False) { 
...
_vvvvvvvvvvvvvvvvvvv7 = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_jo.RunMethod("getSupportActionBar",(Object[])(__c.Null))));
 };
 };
...
__c.LogImpl("99437205","#SupportedOrientations attribute must be set to landscape or portrait.",_vvvvv0.Color_Red);
 };
 };
 }
};
...
_vvvvvvvvvvvvvvvvvvv1 = new cm.jahswant.foodhunter.b4xorderedmap();
 //BA.debugLineNum = 24;BA.debugLine="Private RootB4XToPage As B4XOrderedMap";
_vvvvvvvvvvvvvvvvvvv2 = new cm.jahswant.foodhunter.b4xorderedmap();
 //BA.debugLineNum = 26;BA.debugLine="Private Context As JavaObject";
_vvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4j.object.JavaObject();
...
_vvvvvvvvvvvvvvvvvvv4 = new cm.jahswant.foodhunter.b4xset();
...
_vvvvvvvvvvvvvvvvvvv5 = new anywheresoftware.b4a.objects.ActivityWrapper();
...
_vvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4j.object.JavaObject();
...
_vvvvvvvvvvvvvvvvvvvv1 = (int) (100);
 //BA.debugLineNum = 51;BA.debugLine="Public MainPage As B4XMainPage";
_vvv4 = new cm.jahswant.foodhunter.b4xmainpage();
...
_vvvvvvvvvvvvvvvvvvvv3 = __c.False;
 //BA.debugLineNum = 54;BA.debugLine="End Sub";
return "";
}
public String  _vv5(Object _b4xpage) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = _vvvvvvvvvvvvvvvvv4(_b4xpage);
 //BA.debugLineNum = 211;BA.debugLine="If mStackOfPageIds.Contains(pi.Id) = False Then R";
if (_vvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvv2 /*boolean*/ ((Object)(_pi.Id /*String*/ ))==__c.False) { 
if (true) return "";};
 //BA.debugLineNum = 212;BA.debugLine="If xui.IsB4i And GetTopPage <> pi Then";
if (_vvvvv0.getIsB4i() && (_vvvvvvvvvvvvvvvvv7()).equals(_pi) == false) { 
...
if (true) return "";
 }else if(_vvvvv0.getIsB4i() && _vvvvvvvvvvvvvvvvvvv4._getvvvvvvvvvv2 /*int*/ ()==1) { 
...
if (_vvvvvvvvvvvvvvvvvvv4._getvvvvvvvvvv2 /*int*/ ()==1) { 
...
public boolean  _vvvvvvvvvvvvvvvv6(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
if (true) return _vvvvv0.SubExists(ba,_pi.B4XPage /*Object*/ ,"B4XPage_CloseRequest",(int) (0));
 //BA.debugLineNum = 533;BA.debugLine="End Sub";
return false;
}
public cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvvv7(Object _b4xpage,String _id,boolean _created,Object _title) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _t1 = null;
...
_t1 = new cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo();
...
public cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent  _vvvvvvvvvvvvvvvv0(Object _nativetype) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent _t1 = null;
...
_t1 = new cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent();
...
public String  _vvvvvvvvvvvvvvvvv1(Object _menu) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
anywheresoftware.b4j.object.JavaObject _jo = null;
cm.jahswant.foodhunter.b4xpagesmanager._b4amenuitem _mi = null;
...
{
final anywheresoftware.b4a.BA.IterableList group4 = _pi.Parent /*cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ ;
final int groupLen4 = group4.getSize()
;int index4 = 0;
;
for (; index4 < groupLen4;index4++){
_mi = (cm.jahswant.foodhunter.b4xpagesmanager._b4amenuitem)(group4.Get(index4));
...
public String  _vvvvvvvvvvvvvvvvv2(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.IsFirst /*boolean*/  = _vvvvvvvvvvvvvvvvvvv1._getvvvvvvvvvv2 /*int*/ ()==1;
 //BA.debugLineNum = 352;BA.debugLine="CreatePageImpl (pi)";
_vvvvvvvvvvvvvvvvv3(_pi);
 //BA.debugLineNum = 353;BA.debugLine="pi.Created = True";
_pi.Created /*boolean*/  = __c.True;
 //BA.debugLineNum = 354;BA.debugLine="RootB4XToPage.Put(pi.Root, pi)";
_vvvvvvvvvvvvvvvvvvv2._vvvvvvvvvvvvv3 /*String*/ ((Object)(_pi.Root /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getObject()),(Object)(_pi));
 //BA.debugLineNum = 355;BA.debugLine="LogEvent(pi, \"B4XPage_Created\")";
_vvvvvvvvvvvvvvvvvv1(_pi,"B4XPage_Created");
...
public String  _vvvvvvvvvvvvvvvvv3(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Root /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = _vvvvv0.CreatePanel(ba,"root");
...
_pi.Parent /*cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent*/  = _vvvvvvvvvvvvvvvv0((Object)(_vvvvvvvvvvvvvvvvvvv5.getObject()));
 //BA.debugLineNum = 381;BA.debugLine="pi.Parent.MenuItems.Initialize";
_pi.Parent /*cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
 //BA.debugLineNum = 389;BA.debugLine="End Sub";
return "";
}
public cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvvvv4(Object _page) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
{
final anywheresoftware.b4a.BA.IterableList group1 = _vvvvvvvvvvvvvvvvvvv1._getvvvvvvvvvvvvvvv5 /*anywheresoftware.b4a.objects.collections.List*/ ();
final int groupLen1 = group1.getSize()
;int index1 = 0;
;
for (; index1 < groupLen1;index1++){
_pi = (cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo)(group1.Get(index1));
...
if (true) return (cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo)(__c.Null);
 //BA.debugLineNum = 310;BA.debugLine="End Sub";
return null;
}
public Object  _vv0(String _id) throws Exception{
...
if (true) return _vvvvvvvvvvvvvvvvv5(_id).B4XPage /*Object*/ ;
 //BA.debugLineNum = 393;BA.debugLine="End Sub";
return null;
}
public cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvvvv5(String _id) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvvvvvv1._vvvvvvvvv7 /*Object*/ ((Object)(_id.toLowerCase())));
...
__c.LogImpl("910485764","Ids: "+BA.ObjectToString(_vvvvvvvvvvvvvvvvvvv1._getvvvvvvvvvvvvv2 /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
public cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvvvv6(anywheresoftware.b4a.objects.B4XViewWrapper _root) throws Exception{
...
if (true) return (cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvvvvvv2._vvvvvvvvv7 /*Object*/ ((Object)(_root.getObject())));
 //BA.debugLineNum = 406;BA.debugLine="End Sub";
return null;
}
public cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo  _vvvvvvvvvvvvvvvvv7() throws Exception{
...
if (_vvvvvvvvvvvvvvvvvvv4._getvvvvvvvvvv2 /*int*/ ()==0) { 
if (true) return (cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo)(__c.Null);};
 //BA.debugLineNum = 591;BA.debugLine="Return IdToB4XPage.Get(mStackOfPageIds.AsList.Get";
if (true) return (cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo)(_vvvvvvvvvvvvvvvvvvv1._vvvvvvvvv7 /*Object*/ (_vvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvv1 /*anywheresoftware.b4a.objects.collections.List*/ ().Get((int) (_vvvvvvvvvvvvvvvvvvv4._getvvvvvvvvvv2 /*int*/ ()-1))));
 //BA.debugLineNum = 592;BA.debugLine="End Sub";
return null;
}
public void  _vvvvvvvvvvvvvvvvv0(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
ResumableSub_HandleCloseRequest rsub = new ResumableSub_HandleCloseRequest(this,_pi);
rsub.resume(ba, null);
}
public static class ResumableSub_HandleCloseRequest extends BA.ResumableSub {
public ResumableSub_HandleCloseRequest(cm.jahswant.foodhunter.b4xpagesmanager parent,cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi) {
this.parent = parent;
this._pi = _pi;
}
cm.jahswant.foodhunter.b4xpagesmanager parent;
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi;
...
parent._vvvvvvvvvvvvvvvvvv1(_pi,"B4XPage_CloseRequest");
...
parent._vv5(_pi.B4XPage /*Object*/ );
 if (true) break;
...
public String  _vvvvvvvvvvvvvvvvvv1(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi,String _ev) throws Exception{
String _msg = "";
...
if (_vvvvvvvvvvvvvvvvvvvv3) { 
 //BA.debugLineNum = 639;BA.debugLine="Dim msg As String = $\"*** ${pi.Id}: ${ev} ${Stac";
_msg = ("*** "+__c.SmartStringFormatter("",(Object)(_pi.Id /*String*/ ))+": "+__c.SmartStringFormatter("",(Object)(_ev))+" "+__c.SmartStringFormatter("",(Object)(_vvvvvvvvvvvvvvvvvvvv2))+"");
...
_vvvvvvvvvvvvvvvvvv2(_vvvvvvvvvvvvvvvvv6((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(__c.Sender(ba)))),"B4XPage_Resize",new Object[]{(Object)(_w),(Object)(_h)});
 //BA.debugLineNum = 586;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvv2(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_vvvvvvvvvvvvvvvvvv1(_targetpage,_subname);
 //BA.debugLineNum = 550;BA.debugLine="If xui.SubExists(TargetPage.B4XPage, SubName, len";
if (_vvvvv0.SubExists(ba,_targetpage.B4XPage /*Object*/ ,_subname,_length)==__c.False) { 
if (true) return "";};
...
public Object  _vvvvvvvvvvvvvvvvvv3(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
public String  _vvv5(Object _b4xpage,Object _title) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi.Parent /*cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ .setTitle(BA.ObjectToCharSequence(_title));
 //BA.debugLineNum = 364;BA.debugLine="End Sub";
return "";
}
public String  _vvv6(String _id) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _top = null;
...
_vvvvvvvvvvvvvvvvvv4(_pi);
 //BA.debugLineNum = 176;BA.debugLine="mStackOfPageIds.Add(pi.Id)";
_vvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvv0 /*String*/ ((Object)(_pi.Id /*String*/ ));
 //BA.debugLineNum = 177;BA.debugLine="TopPageAppear";
_vvvvvvvvvvvvvvvvvv5();
 //BA.debugLineNum = 178;BA.debugLine="End Sub";
return "";
}
public String  _vvv7(String _id) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pagetoremove = null;
...
{
final anywheresoftware.b4a.BA.IterableList group8 = _vvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvv1 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
_pagetoremove = _vvvvvvvvvvvvvvvvv5(_id);
...
_vvvvvvvvvvvvvvvvvvv4._vvvvvvvvv6 /*String*/ ();
...
if (_vvvvv0.getIsB4A() || _vvvvv0.getIsB4J()) { 
...
public String  _vvvvvvvvvvvvvvvvvv4(cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
if (_vvvvvvvvvvvvvvvvvvvv1>0) { 
 //BA.debugLineNum = 339;BA.debugLine="mMainForm.AddView(pnl, 0, 0, 20dip, 20dip)";
_vvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),__c.DipToCurrent((int) (20)),__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 340;BA.debugLine="pnl.SetLayoutAnimated(TransitionAnimationDuratio";
_pnl.SetLayoutAnimated(_vvvvvvvvvvvvvvvvvvvv1,(int) (0),(int) (0),__c.PerXToCurrent((float) (100),ba),__c.PerYToCurrent((float) (100),ba));
 }else {
 //BA.debugLineNum = 342;BA.debugLine="mMainForm.AddView(pnl, 0, 0, 100%x, 100%y)";
_vvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_pnl.getObject()),(int) (0),(int) (0),__c.PerXToCurrent((float) (100),ba),__c.PerYToCurrent((float) (100),ba));
 };
 //BA.debugLineNum = 347;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvv5() throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi.Parent /*cm.jahswant.foodhunter.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ .setTitle(BA.ObjectToCharSequence(_pi.Title /*Object*/ ));
...
_vvvvvvvvvvvvvvvvvv2(_pi,"B4XPage_Appear",(Object[])(__c.Null));
 };
 };
 //BA.debugLineNum = 295;BA.debugLine="If ShowUpIndicator And ActionBar.IsInitialized Th";
if (_vvvvvvvvvvvvvvvvvvv6 && _vvvvvvvvvvvvvvvvvvv7.IsInitialized()) { 
 //BA.debugLineNum = 296;BA.debugLine="ActionBar.RunMethod(\"setDisplayHomeAsUpEnabled\",";
_vvvvvvvvvvvvvvvvvvv7.RunMethod("setDisplayHomeAsUpEnabled",new Object[]{(Object)(_vvvvvvvvvvvvvvvvvvv4._getvvvvvvvvvv2 /*int*/ ()>1)});
 };
...
public String  _vvvvvvvvvvvvvvvvvv6() throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo _pi = null;
...
_vvvvvvvvvvvvvvvvvv3(_pi,"B4XPage_Disappear",(Object[])(__c.Null));
 };
 };
 //BA.debugLineNum = 283;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvv7() throws Exception{
...
_vvvvvvvvvvvvvvvvvvv3.RunMethod("invalidateOptionsMenu",(Object[])(__c.Null));
 //BA.debugLineNum = 489;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvv0() throws Exception{
...
{
final anywheresoftware.b4a.BA.IterableList group5 = _vvvvvvvvvvvvvvvvvvv4._vvvvvvvvvvvvvvvv1 /*anywheresoftware.b4a.objects.collections.List*/ ();
final int groupLen5 = group5.getSize()
;int index5 = 0;
;
for (; index5 < groupLen5;index5++){
...
_vvvvvvvvvvvvvvvvvvvv2 = _sb.ToString();
