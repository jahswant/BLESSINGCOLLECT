...
public class wobblemenu extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.wobblemenu");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.wobblemenu.class).invoke(this, new Object[] {null});
        else
...
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = 0;
...
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
...
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = 0;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = 0;
...
public String _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(anywheresoftware.b4a.objects.B4XViewWrapper _element,int _newpos) throws Exception{
...
public ResumableSub_AnimateTo(cm.jahswant.foodhunter.wobblemenu parent,anywheresoftware.b4a.objects.B4XViewWrapper _element,int _newpos) {
this.parent = parent;
this._element = _element;
this._newpos = _newpos;
}
cm.jahswant.foodhunter.wobblemenu parent;
...
_duration = parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2;
...
_tempvalue = (float) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1((float) (parent.__c.DateTime.getNow()-_n),_start,(float) (_newpos-_start),_duration));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = (int) (__c.Min(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getParent().getWidth(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getParent().getHeight()));
 //BA.debugLineNum = 128;BA.debugLine="MenuHeight = (AbsoluteWidth/7) + ((AbsoluteWidth/";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = (int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)7)+((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)7)/(double)4));
 //BA.debugLineNum = 129;BA.debugLine="mBase.Height = MenuHeight";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.setHeight(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5);
 //BA.debugLineNum = 130;BA.debugLine="mBase.Top = mBase.Parent.Height - mBase.Height";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.setTop((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getParent().getHeight()-_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()));
 //BA.debugLineNum = 131;BA.debugLine="circleRadius = AbsoluteWidth/7";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)7);
 //BA.debugLineNum = 133;BA.debugLine="DrawView";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.B4XViewWrapper();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = new anywheresoftware.b4a.objects.B4XViewWrapper();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = new anywheresoftware.b4a.objects.B4XViewWrapper();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.B4XViewWrapper();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.B4XViewWrapper();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.objects.B4XViewWrapper();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = new anywheresoftware.b4a.objects.B4XViewWrapper();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private Tabs,IconList As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = 0;
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = 0;
 //BA.debugLineNum = 33;BA.debugLine="Private CurrentTab As Int";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = 0;
 //BA.debugLineNum = 47;BA.debugLine="Private ShadowColor As String";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = "";
 //BA.debugLineNum = 48;BA.debugLine="Private badge,enabled As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = new anywheresoftware.b4a.objects.collections.List();
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.collections.List();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.B4XViewWrapper();
 //BA.debugLineNum = 63;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4() throws Exception{
int _j = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _tabview = null;
int _tab_width = 0;
cm.jahswant.foodhunter.wobblemenu._icontype _i = null;
...
{
final int step1 = 1;
final int limit1 = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7-1);
_j = (int) (0) ;
...
_tabview = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Get(_j)));
 //BA.debugLineNum = 205;BA.debugLine="tabView.Enabled = enabled.Get(j)";
_tabview.setEnabled(BA.ObjectToBoolean(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.Get(_j)));
 //BA.debugLineNum = 206;BA.debugLine="Dim tab_width As Int = TabContainer.Width/TabCou";
_tab_width = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7);
 //BA.debugLineNum = 207;BA.debugLine="tabView.Color = xui.Color_Transparent";
_tabview.setColor(_vvvvv0.Color_Transparent);
 //BA.debugLineNum = 208;BA.debugLine="TabContainer.AddView(tabView,tab_width*j,0,tab_w";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.AddView((android.view.View)(_tabview.getObject()),(int) (_tab_width*_j),(int) (0),_tab_width,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getHeight());
 //BA.debugLineNum = 210;BA.debugLine="Dim i As IconType:i.Initialize";
_i = new cm.jahswant.foodhunter.wobblemenu._icontype();
 //BA.debugLineNum = 210;BA.debugLine="Dim i As IconType:i.Initialize";
_i.Initialize();
 //BA.debugLineNum = 211;BA.debugLine="If IconList.Size > j Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getSize()>_j) { 
 //BA.debugLineNum = 212;BA.debugLine="i = IconList.Get(j)";
_i = (cm.jahswant.foodhunter.wobblemenu._icontype)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Get(_j));
 }else {
...
_b4xlbl.setTextColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5);
...
_b4xlbl.setTextSize((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6));
...
_b4xlbl.setTextColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7);
 //BA.debugLineNum = 250;BA.debugLine="b4xlbl.Font=designerLbl.Font";
_b4xlbl.setFont(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getFont());
 //BA.debugLineNum = 251;BA.debugLine="b4xlbl.TextSize=TextSize";
_b4xlbl.setTextSize((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7));
...
_jo.RunMethod("setColorFilter",new Object[]{(Object)(__c.Colors.RGB(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5)[(int) (1)],_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5)[(int) (2)],_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5)[(int) (3)]))});};
 };
 //BA.debugLineNum = 297;BA.debugLine="If badge.Size > j Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getSize()>_j) { 
 //BA.debugLineNum = 298;BA.debugLine="If badge.Get(j) <> \"\" Then";
if ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Get(_j)).equals((Object)("")) == false) { 
 //BA.debugLineNum = 299;BA.debugLine="Dim data As Map = badge.Get(j)";
_data = new anywheresoftware.b4a.objects.collections.Map();
_data = (anywheresoftware.b4a.objects.collections.Map) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.Map(), (anywheresoftware.b4a.objects.collections.Map.MyMap)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Get(_j)));
 //BA.debugLineNum = 300;BA.debugLine="SetBadge(j+1,data.Get(\"count\"),data.Get(\"backc";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7((int) (_j+1),(int)(BA.ObjectToNumber(_data.Get((Object)("count")))),(int)(BA.ObjectToNumber(_data.Get((Object)("backcolor")))),(int)(BA.ObjectToNumber(_data.Get((Object)("textcolor")))));
 };
 }else {
 //BA.debugLineNum = 303;BA.debugLine="badge.Add(\"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Add((Object)(""));
 };
 //BA.debugLineNum = 306;BA.debugLine="If IconList.Size < TabCount Then IconList.add(i)";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getSize()<_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7) { 
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Add((Object)(_i));};
 //BA.debugLineNum = 307;BA.debugLine="If j=CurrentTab-1 Then";
if (_j==_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1-1) { 
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(b4a.example.bcpath _path1,float _controlpointx,float _controlpointy,float _targetx,float _targety) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = _vvvvv0.PaintOrColorToColor(_props.Get((Object)("BackgroundColor")));
 //BA.debugLineNum = 87;BA.debugLine="IconColor = xui.PaintOrColorToColor(Props.Get(\"Ic";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = _vvvvv0.PaintOrColorToColor(_props.Get((Object)("IconColor")));
 //BA.debugLineNum = 88;BA.debugLine="IconSize = xui.PaintOrColorToColor(Props.Get(\"Ico";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = _vvvvv0.PaintOrColorToColor(_props.Get((Object)("IconSize")));
 //BA.debugLineNum = 89;BA.debugLine="TextSize = xui.PaintOrColorToColor(Props.Get(\"Tex";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = _vvvvv0.PaintOrColorToColor(_props.Get((Object)("TextSize")));
 //BA.debugLineNum = 90;BA.debugLine="TextColor = xui.PaintOrColorToColor(Props.Get(\"Te";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = _vvvvv0.PaintOrColorToColor(_props.Get((Object)("TextColor")));
 //BA.debugLineNum = 91;BA.debugLine="SelectedIconColor = xui.PaintOrColorToColor(Props";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = _vvvvv0.PaintOrColorToColor(_props.Get((Object)("SelectedIconColor")));
 //BA.debugLineNum = 92;BA.debugLine="animDuration = Props.Get(\"AnimationDuration\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = (int)(BA.ObjectToNumber(_props.Get((Object)("AnimationDuration"))));
 //BA.debugLineNum = 93;BA.debugLine="TabCount = Props.Get(\"TabCount\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = (int)(BA.ObjectToNumber(_props.Get((Object)("TabCount"))));
 //BA.debugLineNum = 94;BA.debugLine="ActiveTab = Props.Get(\"ActiveTab\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = (int)(BA.ObjectToNumber(_props.Get((Object)("ActiveTab"))));
 //BA.debugLineNum = 95;BA.debugLine="ShadowColor = Props.Get(\"ShadowColor\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = BA.ObjectToString(_props.Get((Object)("ShadowColor")));
 //BA.debugLineNum = 96;BA.debugLine="If TabCount = 5 Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7==5) { 
 //BA.debugLineNum = 97;BA.debugLine="CurrentTab = ActiveTab";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0;
 }else {
 //BA.debugLineNum = 99;BA.debugLine="If ActiveTab > TabCount Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0>_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7) { 
 //BA.debugLineNum = 100;BA.debugLine="CurrentTab = 2";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = (int) (2);
 }else {
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _icon_appear_from_edge;
 break; }
case 1: {
 //BA.debugLineNum = 108;BA.debugLine="Case \"FROM CENTER\": IconAppearStyle = ICON_APPEA";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _icon_appear_from_center;
 break; }
case 2: {
 //BA.debugLineNum = 109;BA.debugLine="Case \"FADE IN\": IconAppearStyle = ICON_APPEAR_FA";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _icon_appear_fade_in;
 break; }
case 3: {
 //BA.debugLineNum = 110;BA.debugLine="Case \"NO ANIMATION\": IconAppearStyle = ICON_APPE";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _icon_appear_no_animation;
 break; }
}
;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _animation_type_elastic_out;
 break; }
case 1: {
 //BA.debugLineNum = 115;BA.debugLine="Case \"ELASTIC IN\": AnimationType = ANIMATION_TYP";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _animation_type_elastic_in;
 break; }
case 2: {
 //BA.debugLineNum = 116;BA.debugLine="Case \"EASE OUT\": AnimationType = ANIMATION_TYPE_";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _animation_type_ease_out;
 break; }
case 3: {
 //BA.debugLineNum = 117;BA.debugLine="Case \"EASE IN\": AnimationType = ANIMATION_TYPE_E";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _animation_type_ease_in;
 break; }
case 4: {
 //BA.debugLineNum = 118;BA.debugLine="Case \"NONE\": AnimationType = ANIMATION_TYPE_NONE";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _animation_type_none;
 break; }
}
;
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
...
_circle.Initialize(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5);
 //BA.debugLineNum = 463;BA.debugLine="Dim innerRadius As Int = Min(mBase.Parent.Width,m";
_innerradius = (int) (__c.Min(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getParent().getWidth(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getParent().getHeight())/(double)8);
...
if ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4).equals("Dark")) { 
 //BA.debugLineNum = 466;BA.debugLine="circle.DrawCircle(circleRadius/2,(circleRadius/";
_circle.DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1/(double)2),(float) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1/(double)2)+2),(float) ((_innerradius/(double)2)+_i),_vvvvv0.Color_ARGB((int) (3),(int) (0),(int) (0),(int) (0)),__c.True,(float) (0));
 }else if((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4).equals("Light")) { 
 //BA.debugLineNum = 468;BA.debugLine="circle.DrawCircle(circleRadius/2,(circleRadius/";
_circle.DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1/(double)2),(float) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1/(double)2)+2),(float) ((_innerradius/(double)2)+_i),_vvvvv0.Color_ARGB((int) (3),(int) (255),(int) (255),(int) (255)),__c.True,(float) (0));
 };
 }
};
 //BA.debugLineNum = 472;BA.debugLine="circle.DrawCircle(circleRadius/2,circleRadius/2,i";
_circle.DrawCircle((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1/(double)2),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1/(double)2),(float) (_innerradius/(double)2),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,__c.True,(float) (0));
 //BA.debugLineNum = 473;BA.debugLine="circle.Invalidate";
_circle.Invalidate();
 //BA.debugLineNum = 474;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7() throws Exception{
int[] _backargb = null;
...
_backargb = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4);
...
_curve.Initialize(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_bezierpath,(float) (_swidth/(double)9),(float) (0),(float) (_swidth/(double)7),(float) ((_sheight/(double)3)));
 //BA.debugLineNum = 424;BA.debugLine="CurveTo(BezierPath, sWidth/5 + 5dip, curveHeight";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_bezierpath,(float) (_swidth/(double)5+__c.DipToCurrent((int) (5))),(float) (_curveheight-__c.DipToCurrent((int) (8))),(float) (_swidth/(double)2),(float) (_curveheight));
 //BA.debugLineNum = 425;BA.debugLine="CurveTo(BezierPath, (sWidth-sWidth/5) - 5dip, cur";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_bezierpath,(float) ((_swidth-_swidth/(double)5)-__c.DipToCurrent((int) (5))),(float) (_curveheight-__c.DipToCurrent((int) (8))),(float) (_swidth-(_swidth/(double)7)),(float) ((_sheight/(double)3)));
 //BA.debugLineNum = 426;BA.debugLine="CurveTo(BezierPath, (sWidth-sWidth/9)-2dip, 0, sW";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_bezierpath,(float) ((_swidth-_swidth/(double)9)-__c.DipToCurrent((int) (2))),(float) (0),(float) (_swidth),(float) (0));
...
_shadow = _vvvvv0.Color_ARGB(_backargb[(int) (0)],(int) (__c.Max(0,_backargb[(int) (1)]-20)),(int) (__c.Max(0,_backargb[(int) (2)]-20)),(int) (__c.Max(0,_backargb[(int) (3)]-20)));
 }else if((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4).equals("Light")) { 
 //BA.debugLineNum = 435;BA.debugLine="shadow = xui.Color_ARGB(backARGB(0),Min(255,back";
_shadow = _vvvvv0.Color_ARGB(_backargb[(int) (0)],(int) (__c.Min(255,_backargb[(int) (1)]+20)),(int) (__c.Min(255,_backargb[(int) (2)]+20)),(int) (__c.Min(255,_backargb[(int) (3)]+20)));
 };
...
_bezierview._drawpath(_bezierpath,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,__c.True,(int) (0));
...
_rect.Initialize((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)5)/(double)2-4),(float) (0),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()+(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)5)/(double)2+4),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getHeight()));
...
_rect.Initialize((float) (0),(float) (0),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)5)/(double)2),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getHeight()));
 //BA.debugLineNum = 450;BA.debugLine="curve.DrawRect(rect,BackgroundColor,True,0)";
_curve.DrawRect(_rect,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,__c.True,(float) (0));
 //BA.debugLineNum = 451;BA.debugLine="rect.Initialize(TabContainer.Width +(AbsoluteWidt";
_rect.Initialize((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()+(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)5)/(double)2),(float) (0),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getWidth()),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getHeight()));
...
_curve.DrawLine((float) (0),(float) (0),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)5)/(double)2),(float) (0),_shadow,(float) (4));
 //BA.debugLineNum = 454;BA.debugLine="curve.DrawLine(TabContainer.Width +(AbsoluteWidth";
_curve.DrawLine((float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()+(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6/(double)5)/(double)2),(float) (0),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()*2),(float) (0),_shadow,(float) (4));
 //BA.debugLineNum = 455;BA.debugLine="curve.DrawLine(0,TabContainer.Height,TabContainer";
_curve.DrawLine((float) (0),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getHeight()),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()*2),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getHeight()),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,(float) (4));
 //BA.debugLineNum = 457;BA.debugLine="curve.Invalidate";
_curve.Invalidate();
 //BA.debugLineNum = 458;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
anywheresoftware.b4a.objects.LabelWrapper _icon = null;
anywheresoftware.b4a.objects.ImageViewWrapper _iconimg = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.RemoveAllViews();
 //BA.debugLineNum = 138;BA.debugLine="Tabs.Clear";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Clear();
 //BA.debugLineNum = 139;BA.debugLine="If TabCircle.IsInitialized Then TabCircle.RemoveA";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.IsInitialized()) { 
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.RemoveAllViews();};
 //BA.debugLineNum = 141;BA.debugLine="TabContainer = xui.CreatePanel(\"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _vvvvv0.CreatePanel(ba,"");
 //BA.debugLineNum = 142;BA.debugLine="mBase.AddView(TabContainer,0,mBase.Height/4 ,mBas";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getObject()),(int) (0),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)4),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth(),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)4)));
 //BA.debugLineNum = 143;BA.debugLine="TabCurve = xui.CreatePanel(\"\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = _vvvvv0.CreatePanel(ba,"");
 //BA.debugLineNum = 144;BA.debugLine="TabContainer.AddView(TabCurve,((TabContainer.Widt";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getObject()),(int) (((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7)*(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1-1))+((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7)/(double)2)-((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()*2)/(double)2)),(int) (0),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()*2),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getHeight());
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = _vvvvv0.CreatePanel(ba,"");
 //BA.debugLineNum = 148;BA.debugLine="mBase.AddView(TabCircle,((TabContainer.Width/TabC";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getObject()),(int) (((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7)*(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1-1))+((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getWidth()/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7)/(double)2)-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1/(double)2)),__c.DipToCurrent((int) (1)),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1);
...
_icon.setTextColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_icon.getObject()),(int) (0),(int) (0),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth(),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight());
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_iconimg.getObject()),(int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2)-((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2)/(double)2)),(int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)-((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)/(double)2)),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2));
...
_lw = _vvvvv0.CreatePanel(ba,"");
 //BA.debugLineNum = 177;BA.debugLine="rw = xui.CreatePanel(\"\")";
_rw = _vvvvv0.CreatePanel(ba,"");
 //BA.debugLineNum = 178;BA.debugLine="cw = xui.CreatePanel(\"\")";
_cw = _vvvvv0.CreatePanel(ba,"");
 //BA.debugLineNum = 179;BA.debugLine="lw.Color = BackgroundColor";
_lw.setColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4);
 //BA.debugLineNum = 180;BA.debugLine="rw.Color = BackgroundColor";
_rw.setColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4);
 //BA.debugLineNum = 181;BA.debugLine="cw.Color = BackgroundColor";
_cw.setColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4);
 //BA.debugLineNum = 182;BA.debugLine="TabCircle.AddView(lw,(TabCircle.Height/5),(TabCir";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_lw.getObject()),(int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)5)),(int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)-((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)/(double)2)),__c.DipToCurrent((int) (1)),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2));
 //BA.debugLineNum = 183;BA.debugLine="TabCircle.AddView(rw,TabCircle.Width-(TabCircle.H";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_rw.getObject()),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)5)-__c.DipToCurrent((int) (1))),(int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)-((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)/(double)2)),__c.DipToCurrent((int) (1)),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2));
 //BA.debugLineNum = 184;BA.debugLine="TabCircle.AddView(cw,TabCircle.Width/2,(TabCircle";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_cw.getObject()),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2),(int) ((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)-((_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2)/(double)2)),(int) (0),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2));
 //BA.debugLineNum = 186;BA.debugLine="Tab1 = xui.CreatePanel(\"IconTab\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = _vvvvv0.CreatePanel(ba,"IconTab");
 //BA.debugLineNum = 187;BA.debugLine="Tabs.Add(Tab1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.getObject()));
 //BA.debugLineNum = 188;BA.debugLine="Tab2 = xui.CreatePanel(\"IconTab\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = _vvvvv0.CreatePanel(ba,"IconTab");
 //BA.debugLineNum = 189;BA.debugLine="Tabs.Add(Tab2)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getObject()));
 //BA.debugLineNum = 190;BA.debugLine="Tab3 = xui.CreatePanel(\"IconTab\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = _vvvvv0.CreatePanel(ba,"IconTab");
 //BA.debugLineNum = 191;BA.debugLine="Tabs.Add(Tab3)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.getObject()));
 //BA.debugLineNum = 192;BA.debugLine="Tab4 = xui.CreatePanel(\"IconTab\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = _vvvvv0.CreatePanel(ba,"IconTab");
 //BA.debugLineNum = 193;BA.debugLine="Tabs.Add(Tab4)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1.getObject()));
 //BA.debugLineNum = 194;BA.debugLine="Tab5 = xui.CreatePanel(\"IconTab\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _vvvvv0.CreatePanel(ba,"IconTab");
 //BA.debugLineNum = 195;BA.debugLine="Tabs.Add(Tab5)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2.getObject()));
 //BA.debugLineNum = 197;BA.debugLine="CreateTab";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4();
 //BA.debugLineNum = 198;BA.debugLine="SetCircleIcon";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0();
 //BA.debugLineNum = 199;BA.debugLine="End Sub";
return "";
}
public int[]  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(int _color) throws Exception{
int[] _res = null;
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2() throws Exception{
 //BA.debugLineNum = 607;BA.debugLine="Public Sub GetCurrentTab As Int";
 //BA.debugLineNum = 608;BA.debugLine="Return CurrentTab";
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1;
 //BA.debugLineNum = 609;BA.debugLine="End Sub";
return 0;
}
public boolean  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(int _tabid) throws Exception{
...
if (_tabid>=1 && _tabid<=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7) { 
 //BA.debugLineNum = 713;BA.debugLine="Return enabled.get(TabID-1)";
if (true) return BA.ObjectToBoolean(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.Get((int) (_tabid-1)));
 }else {
 //BA.debugLineNum = 715;BA.debugLine="Log(\"Invalid Tab ID\")";
__c.LogImpl("930670852","Invalid Tab ID",0);
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(__c.Sender(ba))),__c.True);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Initialize();
 //BA.debugLineNum = 70;BA.debugLine="badge.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Initialize();
 //BA.debugLineNum = 71;BA.debugLine="enabled.Initialize2(Array As Boolean(True,True,Tr";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.Initialize2(anywheresoftware.b4a.keywords.Common.ArrayToList(new boolean[]{__c.True,__c.True,__c.True,__c.True,__c.True}));
 //BA.debugLineNum = 72;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(int _tabid) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Set((int) (_tabid-1),(Object)(""));
 //BA.debugLineNum = 685;BA.debugLine="Dim t As B4XView = Tabs.Get(TabID-1)";
_t = new anywheresoftware.b4a.objects.B4XViewWrapper();
_t = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Get((int) (_tabid-1))));
...
__c.LogImpl("930474248","Invalid Tab ID",0);
 };
 //BA.debugLineNum = 692;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(int _animation_type) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _animation_type;
 //BA.debugLineNum = 628;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(int _tabid,int _count,int _backcolor,int _txtcolor) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper _t = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tabid);
...
_b4xlbl.setTextColor(_vvvvv0.PaintOrColorToColor((Object)(_txtcolor)));
...
_b4xlbl.SetColorAndBorder(_vvvvv0.PaintOrColorToColor((Object)(_backcolor)),(int) (0),_vvvvv0.Color_Transparent,(int) (_b4xlbl.getHeight()/(double)2));
 //BA.debugLineNum = 673;BA.debugLine="If TabID = CurrentTab Then b4xlbl.Visible = Fal";
if (_tabid==_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1) { 
_b4xlbl.setVisible(__c.False);};
 //BA.debugLineNum = 674;BA.debugLine="badge.set(TabID-1,CreateMap(\"count\":Count,\"back";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.Set((int) (_tabid-1),(Object)(__c.createMap(new Object[] {(Object)("count"),(Object)(_count),(Object)("backcolor"),(Object)(_backcolor),(Object)("textcolor"),(Object)(_txtcolor)}).getObject()));
 };
 }else {
 //BA.debugLineNum = 677;BA.debugLine="Log(\"Invalid Tab ID\")";
__c.LogImpl("930408726","Invalid Tab ID",0);
 };
 //BA.debugLineNum = 679;BA.debugLine="End Sub";
return "";
}
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
...
public ResumableSub_SetCircleIcon(cm.jahswant.foodhunter.wobblemenu parent) {
this.parent = parent;
}
cm.jahswant.foodhunter.wobblemenu parent;
int _id = 0;
...
//select
this.state = 8;
switch (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3) {
case 0: {
this.state = 3;
if (true) break;
}
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).SetLayoutAnimated((int) (0),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getLeft(),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getTop(),(int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getHeight());
 //BA.debugLineNum = 325;BA.debugLine="TabCircle.GetView(id+3).SetLayoutAnimated(0,Tab";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+3)).SetLayoutAnimated((int) (0),(int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)5)-(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2)),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (3)).getTop(),(int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (3)).getHeight());
 //BA.debugLineNum = 326;BA.debugLine="TabCircle.GetView(id+2).SetVisibleAnimated(0,Tr";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).SetVisibleAnimated((int) (0),parent.__c.True);
 //BA.debugLineNum = 327;BA.debugLine="TabCircle.GetView(id+3).SetVisibleAnimated(0,Tr";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+3)).SetVisibleAnimated((int) (0),parent.__c.True);
 if (true) break;
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+4)).SetLayoutAnimated((int) (0),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getLeft(),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getTop(),(int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+3)).getLeft()-parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getLeft()),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getHeight());
 //BA.debugLineNum = 330;BA.debugLine="TabCircle.GetView(id+4).SetVisibleAnimated(0,Tr";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+4)).SetVisibleAnimated((int) (0),parent.__c.True);
 if (true) break;
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView(_id).SetVisibleAnimated((int) (0),parent.__c.False);
 //BA.debugLineNum = 333;BA.debugLine="TabCircle.GetView(id+1).SetVisibleAnimated(0,Fa";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+1)).SetVisibleAnimated((int) (0),parent.__c.False);
 if (true) break;
...
_cl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView(_id).getObject()));
...
_mtab = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Get((int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1-1))));
...
_cli = (anywheresoftware.b4a.objects.ImageViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ImageViewWrapper(), (android.widget.ImageView)(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+1)).getObject()));
 //BA.debugLineNum = 343;BA.debugLine="Dim i As IconType = IconList.Get(CurrentTab-1)";
_i = (cm.jahswant.foodhunter.wobblemenu._icontype)(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Get((int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1-1)));
...
//C
this.state = 20;
_jo.RunMethod("setColorFilter",new Object[]{(Object)(parent.__c.Colors.RGB(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0)[(int) (1)],parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0)[(int) (2)],parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0)[(int) (3)]))});
if (true) break;
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).SetLayoutAnimated((int) (800),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getLeft(),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getTop(),parent.__c.DipToCurrent((int) (1)),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getHeight());
 //BA.debugLineNum = 387;BA.debugLine="TabCircle.GetView(id+3).SetLayoutAnimated(800,T";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+3)).SetLayoutAnimated((int) (800),(int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-(parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)4)-parent.__c.DipToCurrent((int) (1))),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+3)).getTop(),parent.__c.DipToCurrent((int) (1)),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+3)).getHeight());
 if (true) break;
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+4)).SetLayoutAnimated((int) (800),(int) (parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getTop(),parent.__c.DipToCurrent((int) (1)),parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).getHeight());
 if (true) break;
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView(_id).SetVisibleAnimated((int) (800),parent.__c.True);
 //BA.debugLineNum = 392;BA.debugLine="TabCircle.GetView(id+1).SetVisibleAnimated(800,";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+1)).SetVisibleAnimated((int) (800),parent.__c.True);
 if (true) break;
...
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+2)).SetVisibleAnimated((int) (100),parent.__c.False);
 //BA.debugLineNum = 401;BA.debugLine="TabCircle.GetView(id+3).SetVisibleAnimated(100,Fa";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+3)).SetVisibleAnimated((int) (100),parent.__c.False);
 //BA.debugLineNum = 402;BA.debugLine="TabCircle.GetView(id+4).SetVisibleAnimated(100,Fa";
parent._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.GetView((int) (_id+4)).SetVisibleAnimated((int) (100),parent.__c.False);
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(int _tabid) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(_tabid,__c.True);
 //BA.debugLineNum = 623;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(int _tabid,boolean _triggerevent) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Get((int) (_tabid-1)))),_triggerevent);
 }else {
 //BA.debugLineNum = 616;BA.debugLine="Log(\"Invalid Tab ID\")";
__c.LogImpl("930081028","Invalid Tab ID",0);
 };
 //BA.debugLineNum = 618;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(int _tabid,boolean _enable) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper _t = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6.Set((int) (_tabid-1),(Object)(_enable));
 }else {
 //BA.debugLineNum = 706;BA.debugLine="Log(\"Invalid Tab ID\")";
__c.LogImpl("930605318","Invalid Tab ID",0);
 };
 //BA.debugLineNum = 708;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4(int _icon_appear_style) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = _icon_appear_style;
 //BA.debugLineNum = 633;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(int _count) throws Exception{
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1>_count) { 
 //BA.debugLineNum = 640;BA.debugLine="Log(\"Current Tab ID: \"&CurrentTab)";
__c.LogImpl("930343171","Current Tab ID: "+BA.NumberToString(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1),0);
 //BA.debugLineNum = 641;BA.debugLine="Log(\"Cannot change tab count.\")";
__c.LogImpl("930343172","Cannot change tab count.",0);
 }else {
 //BA.debugLineNum = 643;BA.debugLine="TabCount = count";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = _count;
 //BA.debugLineNum = 644;BA.debugLine="DrawView";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0();
 };
 }else {
 //BA.debugLineNum = 647;BA.debugLine="Log(\"Count must be either 5 or 3.\")";
__c.LogImpl("930343178","Count must be either 5 or 3.",0);
 };
 //BA.debugLineNum = 649;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6(int _tabid,String _text,String _icon,anywheresoftware.b4a.keywords.constants.TypefaceWrapper _iconfont) throws Exception{
cm.jahswant.foodhunter.wobblemenu._icontype _i = null;
anywheresoftware.b4a.objects.B4XViewWrapper _mtab = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.Set((int) (_tabid-1),(Object)(_i));
 //BA.debugLineNum = 493;BA.debugLine="Dim mTab As B4XView = Tabs.Get(TabID-1)";
_mtab = new anywheresoftware.b4a.objects.B4XViewWrapper();
_mtab = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Get((int) (_tabid-1))));
...
__c.LogImpl("929884473","Invalid Tab ID",0);
 };
 //BA.debugLineNum = 542;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7(int _tabid,String _text,anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _icon,boolean _tinted) throws Exception{
cm.jahswant.foodhunter.wobblemenu._icontype _i = null;
anywheresoftware.b4a.objects.B4XViewWrapper _mtab = null;
anywheresoftware.b4a.objects.LabelWrapper _l = null;
anywheresoftware.b4a.objects.ImageViewWrapper _iv = null;
...
__c.LogImpl("929950006","Invalid Tab ID",0);
 };
 //BA.debugLineNum = 604;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(boolean _show,boolean _animate) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.SetVisibleAnimated((int) (300),_show);
 }else {
 //BA.debugLineNum = 725;BA.debugLine="mBase.Visible = show";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.setVisible(_show);
 };
 //BA.debugLineNum = 727;BA.debugLine="End Sub";
return "";
}
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1(float _ctime,float _frompos,float _topos,int _duration) throws Exception{
float _ts = 0f;
float _tc = 0f;
...
switch (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2) {
case 0: {
...
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2(anywheresoftware.b4a.objects.B4XViewWrapper _t,boolean _trigger) throws Exception{
int _i = 0;
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1!=_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.IndexOf((Object)(_t.getObject()))+1) { 
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.IndexOf((Object)(_t.getObject()))+1);};
 //BA.debugLineNum = 749;BA.debugLine="AnimateTo(TabCurve,t.Left+(t.Width/2)-(TabCurve.W";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,(int) (_t.getLeft()+(_t.getWidth()/(double)2)-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4.getWidth()/(double)2)-1));
 //BA.debugLineNum = 750;BA.debugLine="AnimateTo(TabCircle,t.Left+(t.Width/2)-(TabCircle";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5,(int) (_t.getLeft()+(_t.getWidth()/(double)2)-(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()/(double)2)));
 //BA.debugLineNum = 752;BA.debugLine="For i=0 To TabCount-1";
{
final int step4 = 1;
final int limit4 = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7-1);
_i = (int) (0) ;
for (;_i <= limit4 ;_i = _i + step4 ) {
 //BA.debugLineNum = 753;BA.debugLine="Dim tb As B4XView = Tabs.Get(i)";
_tb = new anywheresoftware.b4a.objects.B4XViewWrapper();
_tb = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Get(_i)));
...
if (_trigger && _vvvvv0.SubExists(ba,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+"_Tab"+BA.NumberToString(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1)+"Click",(int) (0))) { 
 //BA.debugLineNum = 769;BA.debugLine="CallSub(mCallBack, mEventName & \"_Tab\"&CurrentTa";
__c.CallSubNew(ba,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+"_Tab"+BA.NumberToString(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1)+"Click");
 };
