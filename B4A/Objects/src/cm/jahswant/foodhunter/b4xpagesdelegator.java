...
public class b4xpagesdelegator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.b4xpagesdelegator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.b4xpagesdelegator.class).invoke(this, new Object[] {null});
        else
...
_vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._activity_actionbarhomeclick /*String*/ ();
...
if (true) return _vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._activity_keypress /*boolean*/ (_keycode);
...
_vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._activity_pause /*String*/ ();
...
_vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvvvvv2 /*String*/ (_vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvvvv7 /*cm.jahswant.foodhunter.b4xpagesmanager._b4xpageinfo*/ (),"B4XPage_PermissionResult",new Object[]{(Object)(_permission),(Object)(_result)});
...
_vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._activity_resume /*String*/ ();
...
_vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvvvvvv1 /*String*/ (_menu);
...
_vvvvvvv4._vv6 /*cm.jahswant.foodhunter.b4xpagesmanager*/ (getActivityBA())._mainform_resize /*String*/ (_width,_height);
