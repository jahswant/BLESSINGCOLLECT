...
public class b4xbitset extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.b4xbitset");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.b4xbitset.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public int[] _vvvvvvvvvv3 = null;
public int _vvvvvvvvvv4 = 0;
...
_vvvvvvvvvv3 = new int[(int) (__c.Bit.ShiftRight(_vvvvvvvvvv4,(int) (5))+1)];
;
 //BA.debugLineNum = 60;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvv7(int _index) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_blockvalue = _vvvvvvvvvv3[_dindex];
...
public String  _vvvvvvvvvv1(int _index,boolean _value) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_vvvvvvvvvv3[_dindex] = _newblockvalue;
