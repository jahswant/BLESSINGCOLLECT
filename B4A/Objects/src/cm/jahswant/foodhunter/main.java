...
public class main extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "cm.jahswant.foodhunter", "cm.jahswant.foodhunter.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "cm.jahswant.foodhunter", "cm.jahswant.foodhunter.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "cm.jahswant.foodhunter.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static boolean _vvvvv5 = false;
...
return vis;}
public static class _api_pay{
public boolean IsInitialized;
public String ORDER_ID;
public String PHONE_MOMO;
...
_vvvvv5 = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 37;BA.debugLine="B4XPages.Delegate.Activity_ActionBarHomeClick";
mostCurrent._vvvvvvv4._v0 /*cm.jahswant.foodhunter.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ ();
 //BA.debugLineNum = 38;BA.debugLine="ActionBarHomeClicked = False";
_vvvvv5 = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 39;BA.debugLine="End Sub";
return "";
}
public static String  _activity_create(boolean _firsttime) throws Exception{
cm.jahswant.foodhunter.b4xpagesmanager _pm = null;
 //BA.debugLineNum = 27;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 28;BA.debugLine="Dim pm As B4XPagesManager";
_pm = new cm.jahswant.foodhunter.b4xpagesmanager();
...
if (true) return mostCurrent._vvvvvvv4._v0 /*cm.jahswant.foodhunter.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (_keycode);
...
mostCurrent._vvvvvvv4._v0 /*cm.jahswant.foodhunter.b4xpagesdelegator*/ ._activity_pause /*String*/ ();
...
mostCurrent._vvvvvvv4._v0 /*cm.jahswant.foodhunter.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (_permission,_result);
...
mostCurrent._vvvvvvv4._v0 /*cm.jahswant.foodhunter.b4xpagesdelegator*/ ._activity_resume /*String*/ ();
...
mostCurrent._vvvvvvv4._v0 /*cm.jahswant.foodhunter.b4xpagesdelegator*/ ._create_menu /*String*/ (_menu);
...
_vvvvv5 = false;
 //BA.debugLineNum = 20;BA.debugLine="Type API_PAY(ORDER_ID As String, PHONE_MOMO As St";
;
