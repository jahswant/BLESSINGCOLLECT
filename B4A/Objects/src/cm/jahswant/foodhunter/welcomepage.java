...
public class welcomepage extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.welcomepage");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.welcomepage.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_B4XPage_CloseRequest(cm.jahswant.foodhunter.welcomepage parent) {
this.parent = parent;
}
cm.jahswant.foodhunter.welcomepage parent;
Object _sf = null;
int _result = 0;
...
this.state = 4;
this.catchState = 9;
 //BA.debugLineNum = 36;BA.debugLine="Dim sf As Object = xui.Msgbox2Async(\"DO YOU REAL";
_sf = parent._vvvvv0.Msgbox2Async(ba,BA.ObjectToCharSequence("DO YOU REALLY WANT TO QUIT ?"),BA.ObjectToCharSequence("BLESSING COLLECT"),"YES","","NO",(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(parent.__c.Null)));
 //BA.debugLineNum = 37;BA.debugLine="Wait For (sf) Msgbox_Result (Result As Int)";
...
;
 //BA.debugLineNum = 38;BA.debugLine="If Result = xui.DialogResponse_Positive Then";
if (true) break;
...
parent.__c.LogImpl("01245194",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
_vvvvv7 = _root1;
 //BA.debugLineNum = 15;BA.debugLine="Root.LoadLayout(\"welcome\")";
_vvvvv7.LoadLayout("welcome",ba);
 //BA.debugLineNum = 17;BA.debugLine="End Sub";
return "";
}
public String  _btnfacebook_click() throws Exception{
 //BA.debugLineNum = 22;BA.debugLine="Private Sub btnFacebook_Click";
 //BA.debugLineNum = 23;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"USERMENU";
_vvvvvvv4._vvv7 /*String*/ (ba,"USERMENU");
 //BA.debugLineNum = 24;BA.debugLine="End Sub";
return "";
}
public String  _btngoogle_click() throws Exception{
 //BA.debugLineNum = 26;BA.debugLine="Private Sub btnGoogle_Click";
 //BA.debugLineNum = 27;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"USERMENU";
_vvvvvvv4._vvv7 /*String*/ (ba,"USERMENU");
