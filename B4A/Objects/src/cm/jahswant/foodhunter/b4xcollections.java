...
public static cm.jahswant.foodhunter.b4xbitset  _vvv0(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
cm.jahswant.foodhunter.b4xbitset _s = null;
...
_s = new cm.jahswant.foodhunter.b4xbitset();
...
public static cm.jahswant.foodhunter.b4xorderedmap  _vvvv1(anywheresoftware.b4a.BA _ba) throws Exception{
...
if (true) return _vvvv2(_ba,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)),(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 32;BA.debugLine="End Sub";
return null;
}
public static cm.jahswant.foodhunter.b4xorderedmap  _vvvv2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
cm.jahswant.foodhunter.b4xorderedmap _m = null;
int _i = 0;
...
_m = new cm.jahswant.foodhunter.b4xorderedmap();
...
_m._vvvvvvvvvvvvv3 /*String*/ (_keys.Get(_i),_values.Get(_i));
 }
};
 };
...
public static cm.jahswant.foodhunter.b4xset  _vvvv3(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 9;BA.debugLine="Public Sub CreateSet As B4XSet";
 //BA.debugLineNum = 10;BA.debugLine="Return CreateSet2(Null)";
if (true) return _vvvv4(_ba,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return null;
}
public static cm.jahswant.foodhunter.b4xset  _vvvv4(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
cm.jahswant.foodhunter.b4xset _s = null;
Object _v = null;
...
_s = new cm.jahswant.foodhunter.b4xset();
...
_s._vvvvvvvvvvvvvvv0 /*String*/ (_v);
 }
};
 };
