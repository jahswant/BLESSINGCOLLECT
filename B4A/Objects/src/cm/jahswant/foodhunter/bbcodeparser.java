...
public class bbcodeparser extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.bbcodeparser");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.bbcodeparser.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public cm.jahswant.foodhunter.b4xset _vvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = null;
public int _vvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = 0;
...
public anywheresoftware.b4a.objects.collections.Map _vvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = null;
public anywheresoftware.b4a.keywords.StringBuilderWrapper _vvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = new cm.jahswant.foodhunter.b4xset();
 //BA.debugLineNum = 7;BA.debugLine="Private Stack As List";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 8;BA.debugLine="Private Start As Int";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = 0;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = ((int)0xff003fff);
 //BA.debugLineNum = 12;BA.debugLine="Public ColorsMap As Map";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 13;BA.debugLine="Public ErrorString As StringBuilder";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 15;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvvvvvvvvvvvvvvvvv2(anywheresoftware.b4a.objects.collections.List _texts,cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data) throws Exception{
anywheresoftware.b4a.objects.collections.List _runs = null;
cm.jahswant.foodhunter.bbcodeparser._bbcodetextnode _textnode = null;
...
_textnode = (cm.jahswant.foodhunter.bbcodeparser._bbcodetextnode)(group3.Get(index3));
 //BA.debugLineNum = 186;BA.debugLine="TextToRun(TextNode, Runs, Data)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv1(_textnode,_runs,_data);
 }
};
...
public cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode  _vvvvvvvvvvvvvvvvvvvvvvvvvv3(String _tag) throws Exception{
cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _n = null;
...
_n = new cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode();
...
public cm.jahswant.foodhunter.bbcodeparser._bbcodetextnode  _vvvvvvvvvvvvvvvvvvvvvvvvvv4(String _text) throws Exception{
cm.jahswant.foodhunter.bbcodeparser._bbcodetextnode _n = null;
...
_n = new cm.jahswant.foodhunter.bbcodeparser._bbcodetextnode();
...
_n.Tags /*anywheresoftware.b4a.objects.collections.List*/ .AddAll(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3);
 //BA.debugLineNum = 170;BA.debugLine="Return n";
if (true) return _n;
 //BA.debugLineNum = 171;BA.debugLine="End Sub";
return null;
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvv5(String _msg) throws Exception{
String _s = "";
...
_s = ("Error (position - "+__c.SmartStringFormatter("",(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv4))+"): "+__c.SmartStringFormatter("",(Object)(_msg))+"");
 //BA.debugLineNum = 157;BA.debugLine="LogColor(s, Colors.Red)";
__c.LogImpl("914745603",_s,__c.Colors.Red);
 //BA.debugLineNum = 161;BA.debugLine="ErrorString.Append(s).Append(CRLF)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv0.Append(_s).Append(__c.CRLF);
 //BA.debugLineNum = 162;BA.debugLine="End Sub";
return "";
}
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvv6(cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag,String _key,cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _s = "";
int _i = 0;
float _v = 0f;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvv7(cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag,cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _id = "";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvv5("Missing view: "+_id);
 };
...
public cm.jahswant.foodhunter.bctextengine._bctextrun  _vvvvvvvvvvvvvvvvvvvvvvvvvv0(cm.jahswant.foodhunter.bbcodeparser._bbcodetextnode _text,cm.jahswant.foodhunter.bctextengine._bctextrun _run) throws Exception{
int _i = 0;
cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag = null;
String _liststyle = "";
int _count = 0;
...
_tag = (cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode)(_text.Tags /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
_run.TextChars /*cm.jahswant.foodhunter.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 /*cm.jahswant.foodhunter.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(((int)0x2022)))+" ");
 }else {
...
_parent = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 /*cm.jahswant.foodhunter.bctextengine._bctextrun*/ ();
 //BA.debugLineNum = 355;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
_run.TextChars /*cm.jahswant.foodhunter.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 /*cm.jahswant.foodhunter.bctextengine._bctextchars*/ (BA.NumberToString((_count))+". ");
 //BA.debugLineNum = 356;BA.debugLine="Dim cr As BCConnectedRuns = parent.Extra.Get(m";
_cr = (cm.jahswant.foodhunter.bctextengine._bcconnectedruns)(_parent.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._extra_connectedruns /*String*/ )));
...
_cr.ConnectedWidth /*int*/  = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 /*cm.jahswant.foodhunter.bctextengine._bcfontmetrics*/ (_run.TextFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/ ,_run.TextColor /*int*/ ).xWidth /*int*/ *3/(double)_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 /*float*/ );
...
public String  _initialize(anywheresoftware.b4a.BA _ba,cm.jahswant.foodhunter.bctextengine _textengine) throws Exception{
innerInitialize(_ba);
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv2 = _vvvvvvv5._vvvv4 /*cm.jahswant.foodhunter.b4xset*/ (ba,anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)("b"),(Object)("u"),(Object)("url"),(Object)("plain"),(Object)("color"),(Object)("img"),(Object)("view"),(Object)("vertical"),(Object)("textsize"),(Object)("alignment"),(Object)("span"),(Object)("indent"),(Object)("list"),(Object)("*"),(Object)("fontawesome"),(Object)("materialicons"),(Object)("e"),(Object)("font"),(Object)("direction")}));
 //BA.debugLineNum = 21;BA.debugLine="ColorsMap = CreateMap(\"black\": xui.Color_Black, _";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = __c.createMap(new Object[] {(Object)("black"),(Object)(_vvvvv0.Color_Black),(Object)("darkgray"),(Object)(_vvvvv0.Color_DarkGray),(Object)("gray"),(Object)(_vvvvv0.Color_Gray),(Object)("lightgray"),(Object)(_vvvvv0.Color_LightGray),(Object)("white"),(Object)(_vvvvv0.Color_White),(Object)("red"),(Object)(_vvvvv0.Color_Red),(Object)("green"),(Object)(_vvvvv0.Color_Green),(Object)("blue"),(Object)(_vvvvv0.Color_Blue),(Object)("yellow"),(Object)(_vvvvv0.Color_Yellow),(Object)("cyan"),(Object)(_vvvvv0.Color_Cyan),(Object)("magenta"),(Object)(_vvvvv0.Color_Magenta),(Object)("transparent"),(Object)(_vvvvv0.Color_Transparent)});
 //BA.debugLineNum = 33;BA.debugLine="mTextEngine = TextEngine";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = _textengine;
 //BA.debugLineNum = 34;BA.debugLine="ErrorString.Initialize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv0.Initialize();
 //BA.debugLineNum = 35;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvvvvvvvvvvvvvvvvvv1(cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _t = null;
cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _n = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Initialize();
 //BA.debugLineNum = 42;BA.debugLine="Stack.Add(CreateTagNode(\"noop\"))";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvv3("noop")));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = _matcher.GetStart((int) (0));
 //BA.debugLineNum = 48;BA.debugLine="If Start > LastMatchEnd And skipUntilEndTag = Fa";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvv4>_lastmatchend && _skipuntilendtag==__c.False) { 
 //BA.debugLineNum = 49;BA.debugLine="ParsedElements.Add(CreateTextNode(Data.Text.Sub";
_parsedelements.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvv4(_data.Text /*String*/ .substring(_lastmatchend,_vvvvvvvvvvvvvvvvvvvvvvvvvvvv4))));
 };
...
if ((_vvvvvvvvvvvvvvvvvvvvvvvvvvv6().Tag /*String*/ ).equals(_tag) == false) { 
 //BA.debugLineNum = 55;BA.debugLine="If StackPeek.CanHaveNestedTags = False Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvv6().CanHaveNestedTags /*boolean*/ ==__c.False) { 
 //BA.debugLineNum = 56;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 58;BA.debugLine="Error(\"Closing tag does not match: \" & tag)";
_vvvvvvvvvvvvvvvvvvvvvvvvvv5("Closing tag does not match: "+_tag);
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvv4>_lastmatchend) { 
...
_n = _vvvvvvvvvvvvvvvvvvvvvvvvvvv6();
...
_parsedelements.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvv4("")));
...
_parsedelements.Add((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvv4(_data.Text /*String*/ .substring(_lastmatchend,_data.Text /*String*/ .length()))));
 };
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvv2(String _raw) throws Exception{
...
public int  _vvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _clr) throws Exception{
...
if (true) return __c.Bit.Or(((int)0xff000000),__c.Bit.ParseInt(_clr.substring((int) (4)),(int) (16)));
 }else if(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv7.ContainsKey((Object)(_clr))) { 
 //BA.debugLineNum = 337;BA.debugLine="Return ColorsMap.Get(clr)";
if (true) return (int)(BA.ObjectToNumber(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv7.Get((Object)(_clr))));
 }else {
 //BA.debugLineNum = 339;BA.debugLine="Error(\"Invalid color value: \" & clr)";
_vvvvvvvvvvvvvvvvvvvvvvvvvv5("Invalid color value: "+_clr);
 //BA.debugLineNum = 340;BA.debugLine="Return xui.Color_Black";
if (true) return _vvvvv0.Color_Black;
 };
 //BA.debugLineNum = 342;BA.debugLine="End Sub";
return 0;
}
public cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode  _vvvvvvvvvvvvvvvvvvvvvvvvvvv4(String _tag) throws Exception{
cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _res = null;
int _i = 0;
int _last = 0;
String _c = "";
String _key = "";
...
if (true) return _vvvvvvvvvvvvvvvvvvvvvvvvvv3(_tag.toLowerCase());};
 //BA.debugLineNum = 107;BA.debugLine="Dim res As BBCodeTagNode = CreateTagNode(\"\")";
_res = _vvvvvvvvvvvvvvvvvvvvvvvvvv3("");
...
public void  _vvvvvvvvvvvvvvvvvvvvvvvvvvv5(cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag,cm.jahswant.foodhunter.bctextengine._bctextrun _run,cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
public ResumableSub_SetImageView(cm.jahswant.foodhunter.bbcodeparser parent,cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag,cm.jahswant.foodhunter.bctextengine._bctextrun _run,cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data) {
this.parent = parent;
this._tag = _tag;
this._run = _run;
this._data = _data;
}
cm.jahswant.foodhunter.bbcodeparser parent;
cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag;
cm.jahswant.foodhunter.bctextengine._bctextrun _run;
cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data;
String _url = "";
String _dir = "";
String _filename = "";
int _width = 0;
...
cm.jahswant.foodhunter.httpjob _j = null;
...
_width = parent._vvvvvvvvvvvvvvvvvvvvvvvvvv6(_tag,"width",_data);
 //BA.debugLineNum = 397;BA.debugLine="Dim height As Int = GetDimensionFromTag(Tag, \"hei";
_height = parent._vvvvvvvvvvvvvvvvvvvvvvvvvv6(_tag,"height",_data);
...
_j = new cm.jahswant.foodhunter.httpjob();
...
_j._vvvvvvvvvvvvvvvvvvvvvv1 /*String*/ (_url);
...
//C
this.state = 9;
_j = (cm.jahswant.foodhunter.httpjob) result[0];
;
...
//if
this.state = 12;
if (_j._vvvvvvvvvvvvvvvvvvvvvvvv7 /*boolean*/ ) { 
this.state = 11;
}if (true) break;
...
_bmp = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(_j._vvvvvvvvvvvvvvvvvvvvvv4 /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ ().getObject()));
...
_j._vvvvvvvvvvvvvvvvvvvvvvvv5 /*String*/ ();
 if (true) break;
...
_bmp = parent._vvvvv0.LoadBitmap(_dir,_filename);
 if (true) break;
...
_bmp = parent._vvvvv0.LoadBitmapResize(_dir,_filename,_width,_height,parent.__c.False);
 if (true) break;
...
_bmp = parent._vvvvv0.LoadBitmapResize(_dir,_filename,_width,(int) (10000),parent.__c.True);
 if (true) break;
...
_bmp = parent._vvvvv0.LoadBitmapResize(_dir,_filename,(int) (10000),_height,parent.__c.True);
 if (true) break;
...
public void  _jobdone(cm.jahswant.foodhunter.httpjob _j) throws Exception{
}
public cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode  _vvvvvvvvvvvvvvvvvvvvvvvvvvv6() throws Exception{
...
if (true) return (cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Get((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getSize()-1)));
 //BA.debugLineNum = 152;BA.debugLine="End Sub";
return null;
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvv7() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Private Sub StackPop";
 //BA.debugLineNum = 143;BA.debugLine="Stack.RemoveAt(Stack.Size - 1)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3.RemoveAt((int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3.getSize()-1));
 //BA.debugLineNum = 144;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvv0(cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvv3.Add((Object)(_tag));
 //BA.debugLineNum = 148;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvvvvvvvvvvvvvvvvvvvv1(cm.jahswant.foodhunter.bbcodeparser._bbcodetextnode _text,anywheresoftware.b4a.objects.collections.List _runslist,cm.jahswant.foodhunter.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
int _i = 0;
cm.jahswant.foodhunter.bbcodeparser._bbcodetagnode _tag = null;
cm.jahswant.foodhunter.bctextengine._bcstyledunderline _uu = null;
String _url = "";
String _clr = "";
String _name = "";
...
_run = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 /*cm.jahswant.foodhunter.bctextengine._bctextrun*/ (_text.Text /*String*/ );
...
_uu = new cm.jahswant.foodhunter.bctextengine._bcstyledunderline();
 //BA.debugLineNum = 207;BA.debugLine="uu.Initialize";
_uu.Initialize();
 //BA.debugLineNum = 208;BA.debugLine="uu.Style = tag.Extra.GetDefault(\"style\", mTex";
_uu.Style /*String*/  = BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .GetDefault((Object)("style"),(Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 /*cm.jahswant.foodhunter.bctextengine._bcstyledunderline*/ .Style /*String*/ )));
...
_uu.Clr /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvv3(BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("color"))));}
else {
_uu.Clr /*int*/  = (int) (0);};
...
_run.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Put((Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._extra_styledunderline /*String*/ ),(Object)(_uu));
 };
 break; }
case 1: {
...
_run.TextDirection /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv1 /*int*/ ;
 };
...
_run.TextColor /*int*/  = __c.Bit.Or(((int)0xff000000),_vvvvvvvvvvvvvvvvvvvvvvvvvvvv6);
 break; }
case 3: {
...
_run.TextColor /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvv3(_clr);
 break; }
case 4: {
 //BA.debugLineNum = 233;BA.debugLine="SetImageView(tag, Run, Data)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvv5(_tag,_run,_data);
...
_run.VerticalOffset /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvv6(_tag,"vertical",_data);
 };
...
_run.View /*anywheresoftware.b4a.objects.B4XViewWrapper*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvv7(_tag,_data);
...
_run.View /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setWidth(_vvvvvvvvvvvvvvvvvvvvvvvvvv6(_tag,"width",_data));};
...
_run.View /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setHeight(_vvvvvvvvvvvvvvvvvvvvvvvvvv6(_tag,"height",_data));};
...
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 /*anywheresoftware.b4a.objects.collections.Map*/ .ContainsKey((Object)(_name))==__c.False) { 
 //BA.debugLineNum = 252;BA.debugLine="Log(\"Font missing from TextEngine.CustomFonts";
__c.LogImpl("915007805","Font missing from TextEngine.CustomFonts: "+_name,0);
 }else {
 //BA.debugLineNum = 254;BA.debugLine="Dim NewFont As B4XFont =  mTextEngine.CustomF";
_newfont = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_name)));
...
_cr.ConnectedWidth /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvv6(_tag,"minwidth",_data);
...
_parent = (cm.jahswant.foodhunter.bctextengine._bctextrun)(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("run")));
...
_run.TextChars /*cm.jahswant.foodhunter.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 /*cm.jahswant.foodhunter.bctextengine._bctextchars*/ (new String[]{BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))},(int) (0),(int) (1));
...
_run.TextDirection /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 /*int*/ ;
 break; }
case 2: {
 //BA.debugLineNum = 289;BA.debugLine="Run.TextDirection = mTextEngine.TextDirectio";
_run.TextDirection /*int*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv2 /*int*/ ;
 break; }
}
;
 break; }
...
_currentfont = _vvvvv0.CreateFontAwesome((float) (_fontsize));
 }else {
 //BA.debugLineNum = 296;BA.debugLine="CurrentFont = xui.CreateMaterialIcons(FontSiz";
_currentfont = _vvvvv0.CreateMaterialIcons((float) (_fontsize));
 };
 //BA.debugLineNum = 298;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
_run.TextChars /*cm.jahswant.foodhunter.bctextengine._bctextchars*/  = _vvvvvvvvvvvvvvvvvvvvvvvvvvvv5._vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 /*cm.jahswant.foodhunter.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(_vvvvvvvvvvvvvvvvvvvvvvvvvvv2(BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))))));
...
_run = _vvvvvvvvvvvvvvvvvvvvvvvvvv0(_text,_run);
 };
...
_run.TextFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = _vvvvv0.CreateFont2(_currentfont,(float) (_fontsize));
 };
