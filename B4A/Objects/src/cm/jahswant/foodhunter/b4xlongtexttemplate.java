...
public class b4xlongtexttemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.b4xlongtexttemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.b4xlongtexttemplate.class).invoke(this, new Object[] {null});
        else
...
public Object _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = null;
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = new Object();
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.LoadLayout("LongTextTemplate",ba);
...
_customlistview1._addtextitem(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0,(Object)(""));
...
_vvvvvvv7._vvvv6 /*String*/ (ba,_customlistview1,_customlistview1._defaulttextbackgroundcolor);
