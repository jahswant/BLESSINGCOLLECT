...
public class sd_icontextview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cm.jahswant.foodhunter.sd_icontextview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cm.jahswant.foodhunter.sd_icontextview.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(double _width,double _height) throws Exception{
 //BA.debugLineNum = 150;BA.debugLine="Private Sub Base_Resize (Width As Double, Height A";
 //BA.debugLineNum = 151;BA.debugLine="If RTL Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5) { 
 //BA.debugLineNum = 152;BA.debugLine="MyEditText.Width=Width-50dip";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setWidth((int) (_width-__c.DipToCurrent((int) (50))));
 //BA.debugLineNum = 153;BA.debugLine="MyEditText.Height=Height";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setHeight((int) (_height));
 //BA.debugLineNum = 154;BA.debugLine="LabelHint.Left=Width-45dip";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setLeft((int) (_width-__c.DipToCurrent((int) (45))));
 //BA.debugLineNum = 155;BA.debugLine="LabelHint.Height=Height";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setHeight((int) (_height));
 }else {
 //BA.debugLineNum = 157;BA.debugLine="MyEditText.Width=Width-50dip";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setWidth((int) (_width-__c.DipToCurrent((int) (50))));
 //BA.debugLineNum = 158;BA.debugLine="MyEditText.Height=Height";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setHeight((int) (_height));
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_base));
 //BA.debugLineNum = 42;BA.debugLine="Tag = mBase.Tag";
_vvvvvvvvvvvvvvvvvvvvvvvvv7 = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getTag();
 //BA.debugLineNum = 43;BA.debugLine="mBase.Tag = Me";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.setTag(this);
 //BA.debugLineNum = 44;BA.debugLine="Dim lbx As B4XView = Lbl";
...
_lbx = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 47;BA.debugLine="Dim ED As EditText";
_ed = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 48;BA.debugLine="ED.Initialize(\"MyEditText\")";
_ed.Initialize(ba,"MyEditText");
 //BA.debugLineNum = 49;BA.debugLine="If Props.ContainsKey(\"Password\") Then";
if (_props.ContainsKey((Object)("Password"))) { 
 //BA.debugLineNum = 50;BA.debugLine="If Props.Get(\"Password\").As(Boolean) Then ED.In";
if ((BA.ObjectToBoolean(_props.Get((Object)("Password"))))) { 
_ed.setInputType(__c.Bit.Or(_ed.getInputType(),((int)0x00000080)));};
 };
 //BA.debugLineNum = 68;BA.debugLine="MyEditText=ED";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0 = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_ed.getObject()));
 //BA.debugLineNum = 70;BA.debugLine="If Props.ContainsKey(\"RTL\") Then RTL=Props.Get(\"R";
if (_props.ContainsKey((Object)("RTL"))) { 
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5 = BA.ObjectToBoolean(_props.Get((Object)("RTL")));};
 //BA.debugLineNum = 71;BA.debugLine="If Props.ContainsKey(\"Style\") Then Style=Props.Ge";
if (_props.ContainsKey((Object)("Style"))) { 
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7 = BA.ObjectToString(_props.Get((Object)("Style")));};
 //BA.debugLineNum = 72;BA.debugLine="If Props.ContainsKey(\"CornerColor\") Then CornerCo";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = _lbx.getTextColor();};
 //BA.debugLineNum = 73;BA.debugLine="If Props.ContainsKey(\"Background\") Then	BClr=xui.";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6 = _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getColor();};
 //BA.debugLineNum = 74;BA.debugLine="Corner=Props.Get(\"Corner\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = (int)(BA.ObjectToNumber(_props.Get((Object)("Corner"))));
 //BA.debugLineNum = 75;BA.debugLine="Corner=Corner*(100dip/100)";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3 = (int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3*(__c.DipToCurrent((int) (100))/(double)100));
 //BA.debugLineNum = 82;BA.debugLine="MyEditText.Text=lbx.Text";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setText(BA.ObjectToCharSequence(_lbx.getText()));
 //BA.debugLineNum = 83;BA.debugLine="MyEditText.TextColor=lbx.TextColor";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setTextColor(_lbx.getTextColor());
 //BA.debugLineNum = 84;BA.debugLine="MyEditText.TextSize=lbx.TextSize";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setTextSize(_lbx.getTextSize());
 //BA.debugLineNum = 85;BA.debugLine="MyEditText.Font=lbx.Font";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setFont(_lbx.getFont());
 //BA.debugLineNum = 86;BA.debugLine="MyEditText.Color=xui.Color_Transparent";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.setColor(_vvvvv0.Color_Transparent);
 //BA.debugLineNum = 88;BA.debugLine="LabelHint.Text=Chr(0xF006) 'lbx.EditTextHint";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setText(BA.ObjectToCharSequence(__c.Chr(((int)0xf006))));
 //BA.debugLineNum = 89;BA.debugLine="LabelHint.TextColor=lbx.TextColor";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setTextColor(_lbx.getTextColor());
 //BA.debugLineNum = 90;BA.debugLine="LabelHint.Color=xui.Color_Transparent";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setColor(_vvvvv0.Color_Transparent);
 //BA.debugLineNum = 91;BA.debugLine="LabelHint.SetTextAlignment(\"CENTER\",\"CENTER\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.SetTextAlignment("CENTER","CENTER");
 //BA.debugLineNum = 92;BA.debugLine="LabelHint.Font=xui.CreateFontAwesome(MyEditText.F";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setFont(_vvvvv0.CreateFontAwesome(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.getFont().getSize()));
 //BA.debugLineNum = 94;BA.debugLine="Select Style";
switch (BA.switchObjectToInt(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7,"Frame","Bead")) {
case 0: {
 //BA.debugLineNum = 96;BA.debugLine="mBase.SetColorAndBorder(BClr,1dip,CornerColor,C";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.SetColorAndBorder(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6,__c.DipToCurrent((int) (1)),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3);
 break; }
case 1: {
 //BA.debugLineNum = 98;BA.debugLine="LabelHint.TextColor=BClr";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.setTextColor(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6);
 //BA.debugLineNum = 99;BA.debugLine="LabelHint.SetColorAndBorder(CornerColor,0dip,xu";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.SetColorAndBorder(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,__c.DipToCurrent((int) (0)),_vvvvv0.Color_Transparent,__c.DipToCurrent((int) (20)));
 //BA.debugLineNum = 101;BA.debugLine="Dim Can As B4XCanvas";
_can = new anywheresoftware.b4a.objects.B4XCanvas();
 //BA.debugLineNum = 102;BA.debugLine="Dim Rec As B4XRect";
_rec = new anywheresoftware.b4a.objects.B4XCanvas.B4XRect();
 //BA.debugLineNum = 104;BA.debugLine="Can.Initialize(mBase)";
_can.Initialize(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5);
 //BA.debugLineNum = 105;BA.debugLine="Rec.Initialize(20dip,mBase.Height/2,mBase.Width";
_rec.Initialize((float) (__c.DipToCurrent((int) (20))),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()/(double)2),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-__c.DipToCurrent((int) (20))),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()));
 //BA.debugLineNum = 106;BA.debugLine="Can.DrawRect(Rec,CornerColor,True,0dip)";
_can.DrawRect(_rec,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,__c.True,(float) (__c.DipToCurrent((int) (0))));
 //BA.debugLineNum = 107;BA.debugLine="If RTL Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5) { 
 //BA.debugLineNum = 108;BA.debugLine="Dim Rec As B4XRect";
_rec = new anywheresoftware.b4a.objects.B4XCanvas.B4XRect();
 //BA.debugLineNum = 109;BA.debugLine="Rec.Initialize(0dip,0dip,mBase.Width-45dip,mBa";
_rec.Initialize((float) (__c.DipToCurrent((int) (0))),(float) (__c.DipToCurrent((int) (0))),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-__c.DipToCurrent((int) (45))),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()-__c.DipToCurrent((int) (1))));
 //BA.debugLineNum = 110;BA.debugLine="Dim Path As B4XPath";
_path = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 111;BA.debugLine="Path.InitializeRoundedRect(Rec,20dip)";
_path.InitializeRoundedRect(_rec,(float) (__c.DipToCurrent((int) (20))));
 //BA.debugLineNum = 112;BA.debugLine="Can.DrawPath(Path,BClr,True,0dip)";
_can.DrawPath(_path,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6,__c.True,(float) (__c.DipToCurrent((int) (0))));
 }else {
 //BA.debugLineNum = 114;BA.debugLine="Dim Rec As B4XRect";
_rec = new anywheresoftware.b4a.objects.B4XCanvas.B4XRect();
 //BA.debugLineNum = 115;BA.debugLine="Rec.Initialize(45dip,0dip,mBase.Width,mBase.He";
_rec.Initialize((float) (__c.DipToCurrent((int) (45))),(float) (__c.DipToCurrent((int) (0))),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()),(float) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight()-__c.DipToCurrent((int) (1))));
 //BA.debugLineNum = 116;BA.debugLine="Dim Path As B4XPath";
_path = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 117;BA.debugLine="Path.InitializeRoundedRect(Rec,20dip)";
_path.InitializeRoundedRect(_rec,(float) (__c.DipToCurrent((int) (20))));
 //BA.debugLineNum = 118;BA.debugLine="Can.DrawPath(Path,BClr,True,0dip)";
_can.DrawPath(_path,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv6,__c.True,(float) (__c.DipToCurrent((int) (0))));
 };
 //BA.debugLineNum = 120;BA.debugLine="Can.Invalidate";
_can.Invalidate();
 break; }
}
;
 //BA.debugLineNum = 124;BA.debugLine="If RTL Then";
if (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5) { 
 //BA.debugLineNum = 125;BA.debugLine="mBase.AddView(LabelHint,mBase.Width-45dip,0dip,4";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getObject()),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-__c.DipToCurrent((int) (45))),__c.DipToCurrent((int) (0)),__c.DipToCurrent((int) (40)),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight());
 //BA.debugLineNum = 126;BA.debugLine="mBase.AddView(MyEditText,5dip,0dip,mBase.Width-5";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.getObject()),__c.DipToCurrent((int) (5)),__c.DipToCurrent((int) (0)),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-__c.DipToCurrent((int) (50))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight());
 //BA.debugLineNum = 133;BA.debugLine="MyEditText.SetTextAlignment(\"CENTER\",\"RIGHT\")";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.SetTextAlignment("CENTER","RIGHT");
 //BA.debugLineNum = 134;BA.debugLine="Dim TF = MyEditText As JavaObject";
...
_tf = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.getObject()));
 //BA.debugLineNum = 135;BA.debugLine="TF.RunMethod(\"setPadding\", Array As Object(5dip";
_tf.RunMethod("setPadding",new Object[]{(Object)(__c.DipToCurrent((int) (5))),(Object)(__c.DipToCurrent((int) (0))),(Object)(__c.DipToCurrent((int) (5))),(Object)(__c.DipToCurrent((int) (0)))});
 ...
 //BA.debugLineNum = 138;BA.debugLine="mBase.AddView(LabelHint,5dip,0dip,40dip,mBase.He";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv7.getObject()),__c.DipToCurrent((int) (5)),__c.DipToCurrent((int) (0)),__c.DipToCurrent((int) (40)),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight());
 //BA.debugLineNum = 139;BA.debugLine="mBase.AddView(MyEditText,50dip,0dip,mBase.Width-";
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.AddView((android.view.View)(_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0.getObject()),__c.DipToCurrent((int) (50)),__c.DipToCurrent((int) (0)),(int) (_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getWidth()-__c.DipToCurrent((int) (50))),_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5.getHeight());
 //BA.debugLineNum = 144;BA.debugLine="MyEditText.SetTextAlignment(\"CENTER\",\"LEFT\")";
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3() throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Public Sub GetBase As B4XView";
 //BA.debugLineNum = 164;BA.debugLine="Return mBase";
...
public String  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Public Sub getHint As String";
 //BA.debugLineNum = 182;BA.debugLine="Return LabelHint.Text";
...
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Public Sub getHintFont As B4XFont";
 //BA.debugLineNum = 190;BA.debugLine="Return LabelHint.Font";
...
public anywheresoftware.b4a.objects.EditTextWrapper  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4() throws Exception{
 //BA.debugLineNum = 168;BA.debugLine="Public Sub getNativeObject As EditText";
 //BA.debugLineNum = 169;BA.debugLine="Return MyEditText";
...
public String  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Public Sub getText As String";
 //BA.debugLineNum = 198;BA.debugLine="Return MyEditText.Text";
...
public anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont  _getvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5() throws Exception{
 //BA.debugLineNum = 205;BA.debugLine="Public Sub getTextFont As B4XFont";
 //BA.debugLineNum = 206;BA.debugLine="Return MyEditText.Font";
...
_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4 = _callback;
 //BA.debugLineNum = 33;BA.debugLine="Dim LH As Label";
_lh = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 34;BA.debugLine="LH.Initialize(\"LabelHint\")";
_lh.Initialize(ba,"LabelHint");
 //BA.debugLineNum = 35;BA.debugLine="LabelHint=LH";
...
public String  _labelhint_click() throws Exception{
 //BA.debugLineNum = 235;BA.debugLine="Private Sub LabelHint_Click";
 //BA.debugLineNum = 236;BA.debugLine="If xui.SubExists(mCallBack,mEventName & \"_HintCli";
...
public String  _myedittext_action() throws Exception{
 //BA.debugLineNum = 231;BA.debugLine="Private Sub MyEditText_Action";
 //BA.debugLineNum = 232;BA.debugLine="If xui.SubExists(mCallBack,mEventName & \"_EnterPr";
...
public String  _myedittext_beginedit() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Private Sub MyEditText_BeginEdit";
 //BA.debugLineNum = 224;BA.debugLine="If xui.SubExists(mCallBack,mEventName & \"_FocusCh";
...
public String  _myedittext_endedit() throws Exception{
 //BA.debugLineNum = 227;BA.debugLine="Private Sub MyEdittext_EndEdit";
 //BA.debugLineNum = 228;BA.debugLine="If xui.SubExists(mCallBack,mEventName & \"_FocusCh";
if (_vvvvv0.SubExists(ba,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+"_FocusChanged",(int) (1))) { 
...
public String  _myedittext_enterpressed() throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="private Sub MyEditText_EnterPressed";
 //BA.debugLineNum = 216;BA.debugLine="If xui.SubExists(mCallBack,mEventName & \"_EnterPr";
if (_vvvvv0.SubExists(ba,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+"_EnterPressed",(int) (0))) { 
__c.CallSubNew(ba,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+"_EnterPressed");};
...
public String  _myedittext_focuschanged(boolean _hasfocus) throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Private Sub MyEditText_FocusChanged (HasFocus As B";
 //BA.debugLineNum = 220;BA.debugLine="If xui.SubExists(mCallBack,mEventName & \"_FocusCh";
if (_vvvvv0.SubExists(ba,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv4,_vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3+"_FocusChanged",(int) (1))) { 
...
public String  _myedittext_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Private Sub MyEditText_TextChanged (Old As String,";
 //BA.debugLineNum = 212;BA.debugLine="If xui.SubExists(mCallBack,mEventName & \"_TextCha";
...
public String  _setvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv3(String _text) throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Public Sub setHint(Text As String)";
 //BA.debugLineNum = 178;BA.debugLine="LabelHint.Text=Text";
...
public String  _setvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont _fnt) throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Public Sub setHintFont(Fnt As B4XFont)";
 //BA.debugLineNum = 186;BA.debugLine="LabelHint.Font=Fnt";
...
public String  _setvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv0(String _text) throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Public Sub setText(Text As String)";
 //BA.debugLineNum = 194;BA.debugLine="MyEditText.Text=Text";
...
public String  _setvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv5(anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont _fnt) throws Exception{
 //BA.debugLineNum = 201;BA.debugLine="Public Sub setTextFont(Fnt As B4XFont)";
 //BA.debugLineNum = 202;BA.debugLine="MyEditText.Font=Fnt";
